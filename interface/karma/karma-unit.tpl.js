module.exports = function ( karma ) {
  karma.set({
    ...
    files: [
      ...
      <% }); %>
      'src/**/*.js',
      //'src/**/*.coffee', // Commented out to disable a warning in karma:unit.
    ],
    exclude: [
      'src/assets/**/*.js',
      'src/test_e2e/**/*.js',
     ...
     * http://localhost:9018/ when you're running tests. The window/tab can be
     * left open and the tests will automatically occur there during the build.
