...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Sample',
            fields=[
                ('sample', models.CharField(max_length=80, serialize=False, verbose_name=b'sample source', primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cel_file', models.CharField(max_length=120, verbose_name=b'CEL file', blank=True)),
                ...
                ('biotic_interactor_level_1', models.CharField(max_length=70, verbose_name=b'biotic interactor level 1 (Plant, Human, Bacteria, \xe2\x80\xa6)', blank=True)),
                ('biotic_interactor_level_2', models.CharField(max_length=80, verbose_name=b'biotic interactor level 2 (Lung, epithelial cells, Staphylococcus aureus, \xe2\x80\xa6)', blank=True)),
