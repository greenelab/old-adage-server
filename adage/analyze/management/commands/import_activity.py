...
def valid_node_names(nodes, ml_model_name):
    ...
    for index, name in enumerate(nodes):
        if not name or name.isspace():
            ...
            logger.error("Line #1 column #%d: %s is NOT unique", index + 2,
                         name)
            return False
...
def valid_data_line(line_num, data_line):
    ...
    for index, value in enumerate(values):
        try:
            ...
            logger.error("Error on line #%d column #%d: %s is NOT float type",
...
def valid_activity(file_handler, ml_model_name):
    ...
    for line_index, line in enumerate(file_handler):
        ...
        if line_index == 0:
            ...
            logger.error("Error on line #%d: Number of fields is not %d",
