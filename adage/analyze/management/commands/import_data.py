...
def import_default_experiments():
    ...
    # TODO pass in the data file on the command line and automate this
    # conversion
    # generate this list with (datasets_list_* file from ADAGE_server
    # on Dropbox):
    # > cut -f 1 datasets_list_02.22.2014.txt | python -c "import fileinput;
    #   print [ename.rstrip() for ename in fileinput.input()]"
    adage_exps = [
    ...
    # note: if the print statement fails due to unicode translation, try this
    # in the shell> export PYTHONIOENCODING=utf-8
    for e in exps:
